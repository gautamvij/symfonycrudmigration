...
class TodoController extends Controller
{
    ...
    /**
     * @Route("/todos/create", name="todo_list_create")
     */
    ...
    //
    /**
     * @Route("/todos/edit/{id}", name="todo_list_edit")
     */
    ...
    /**
     * @Route("/todos/details/{id}", name="todo_list_detils")
     */
    ...
    /**
     * @Route("/todos/delete/{id}", name="todo_list_delete")
     */
